...
export const initialRequirements: Requirement[] = [
  {
    ...
    "_raw": "RTM ID\tRequirement Statement\tLayer\tControl Objective\tParent Requirement\tOutcome\tRationale\tStatus\tPriority\tTest Case ID\tOwner\tAcceptance Criteria\tVersion\tLast Modified\tDependencies\tIntegration Point\tIdentity Types\tMove Types"
  },
  {
    "id": "RBAC-ENT-001",
