...
export const initialWorkstreams: Workstream[] = [
  {
    ...
    activities: [
      ...
      { id: 'WS-01-A3', title: 'Stakeholder alignment and decision facilitation', order: 3 },
    ],
  },
  {
    id: 'WS-02',
    ...
    activities: [
      ...
      { id: 'WS-02-A3', title: 'Establish role governance, ownership, and approval expectations', order: 3 },
    ],
  },
  {
    id: 'WS-03',
    ...
    activities: [
      ...
      { id: 'WS-03-A3', title: 'Align authoritative sources and identity attributes', order: 3 },
    ],
  },
  {
    id: 'WS-04',
    ...
    activities: [
      ...
      { id: 'WS-04-A3', title: 'Align HCM outputs to RBAC and downstream provisioning needs', order: 3 },
    ],
  },
  {
    id: 'WS-05',
    ...
    activities: [
      ...
      { id: 'WS-05-A3', title: 'Identify privileged and sensitive access', order: 3 },
    ],
  },
  {
    id: 'WS-06',
    ...
    activities: [
      ...
      { id: 'WS-06-A3', title: 'Configure and integrate IGA tooling to enforce RBAC decisions', order: 3 },
    ],
  },
  {
    id: 'WS-07',
    ...
    activities: [
      ...
      { id: 'WS-07-A3', title: 'Integrate ServiceNow with IGA and identity sources', order: 3 },
    ],
  },
  {
    id: 'WS-08',
    ...
    activities: [
      ...
      { id: 'WS-08-A3', title: 'Address technical constraints and non-functional requirements', order: 3 },
    ],
  },
  {
    id: 'WS-09',
    ...
    activities: [
      ...
      { id: 'WS-09-A3', title: 'Plan phased rollout to additional systems', order: 3 },
    ],
  },
  {
    id: 'WS-10',
    ...
    activities: [
      ...
      { id: 'WS-10-A3', title: 'Establish success metrics and ongoing improvements', order: 3 },
    ],
  },
];
