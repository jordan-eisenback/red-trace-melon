    ...
    activities: [
      {
        ...
        order: 1,
        steps: [
          { id: 'step-pl-1-1', title: 'Define access intent and governance policy', order: 1, complianceTags: ['ISO27001', 'NIST'], linkedStoryIds: ['US-7.1'] },
          { id: 'step-pl-1-2', title: 'Delegate provisioning and certification execution to IGA', order: 2, linkedStoryIds: ['US-7.2', 'US-7.3'] },
          ...
          { id: 'step-pl-1-4', title: 'Define hybrid on-premises and SaaS topology', order: 4, complianceTags: ['ISO27001'], linkedStoryIds: ['US-7.5', 'US-7.6'] },
      ...
      },
      {
        ...
        order: 2,
        steps: [
          { id: 'step-pl-2-1', title: 'Run application RBAC discovery model', order: 1, complianceTags: ['SOC2'], linkedStoryIds: ['US-1.2', 'US-1.3'] },
          { id: 'step-pl-2-2', title: 'Identify business and technical owners', order: 2, linkedStoryIds: ['US-1.4'] },
          { id: 'step-pl-2-3', title: 'Capture permission inventory and privilege paths', order: 3, complianceTags: ['SOC2', 'ISO27001'], linkedStoryIds: ['US-1.5', 'US-1.6'] },
          { id: 'step-pl-2-4', title: 'Capture SoD considerations during onboarding', order: 4, complianceTags: ['SOX'], linkedStoryIds: ['US-1.7'] },
          { id: 'step-pl-2-5', title: 'Ingest directory accounts and group memberships', order: 5, complianceTags: ['ISO27001'], linkedStoryIds: ['US-8.2', 'US-8.3'] },
          { id: 'step-pl-2-6', title: 'Flag privileged directory groups for governance', order: 6, complianceTags: ['SOC2', 'NIST'], linkedStoryIds: ['US-8.4', 'US-1.6'] },
          { id: 'step-pl-2-7', title: 'Support scalable onboarding without bespoke redesign', order: 7, linkedStoryIds: ['US-10.1'] },
        ],
      },
      {
        id: 'act-pl-roles',
        ...
        order: 3,
        steps: [
          { id: 'step-pl-3-1', title: 'Define business roles with documented purpose and owner', order: 1, complianceTags: ['ISO27001'], linkedStoryIds: ['US-2.3', 'US-2.5'] },
          { id: 'step-pl-3-2', title: 'Enforce role eligibility criteria via identity attributes', order: 2, linkedStoryIds: ['US-2.4', 'US-2.21'] },
          { id: 'step-pl-3-3', title: 'Map roles to permissions with required justification', order: 3, complianceTags: ['SOC2'], linkedStoryIds: ['US-2.12', 'US-2.13'] },
          { id: 'step-pl-3-4', title: 'Support role composition and hierarchy', order: 4, linkedStoryIds: ['US-2.9'] },
          { id: 'step-pl-3-5', title: 'Gate material role changes behind approval workflow', order: 5, complianceTags: ['SOC2', 'SOX'], linkedStoryIds: ['US-2.11', 'US-2.14'] },
          { id: 'step-pl-3-6', title: 'Run periodic role reviews and retire unused roles', order: 6, complianceTags: ['ISO27001'], linkedStoryIds: ['US-2.10'] },
          { id: 'step-pl-3-7', title: 'Auto-revoke access when role is removed from user', order: 7, complianceTags: ['SOC2'], linkedStoryIds: ['US-2.8', 'US-2.23'] },
        ],
      },
      {
        ...
        steps: [
          ...
          { id: 'step-pl-4-3', title: 'Consume JML lifecycle events from Workday HR', order: 3, complianceTags: ['ISO27001'], linkedStoryIds: ['US-9.1', 'US-9.2'] },
          { id: 'step-pl-4-4', title: 'Integrate ServiceNow ITSM for access request intake', order: 4, linkedStoryIds: ['US-7.44', 'US-7.45', 'US-7.46'] },
          { id: 'step-pl-4-5', title: 'Detect and remediate out-of-band access grants', order: 5, complianceTags: ['SOC2', 'ISO27001'], linkedStoryIds: ['US-7.16', 'US-7.41', 'US-8.6'] },
          { id: 'step-pl-4-6', title: 'Provision and deprovision directory memberships', order: 6, linkedStoryIds: ['US-8.5', 'US-2.22'] },
          { id: 'step-pl-4-7', title: 'Auto-revoke access on attribute or role change', order: 7, complianceTags: ['SOC2'], linkedStoryIds: ['US-7.29', 'US-2.8'] },
        ],
      },
      {
        ...
        order: 5,
        steps: [
          { id: 'step-pl-5-1', title: 'Configure periodic certification campaigns by role/entitlement', order: 1, complianceTags: ['SOC2', 'SOX'], linkedStoryIds: ['US-7.18', 'US-7.37'] },
          { id: 'step-pl-5-2', title: 'Support role-level and entitlement-level certification tracks', order: 2, complianceTags: ['SOC2'], linkedStoryIds: ['US-7.20', 'US-7.38'] },
          { id: 'step-pl-5-3', title: 'Auto-revoke access when certification removal is approved', order: 3, slaHours: 24, complianceTags: ['SOC2', 'ISO27001'], linkedStoryIds: ['US-7.21', 'US-7.33'] },
          { id: 'step-pl-5-4', title: 'Support delegation, escalation, and overdue tracking', order: 4, complianceTags: ['SOC2'], linkedStoryIds: ['US-7.22', 'US-7.39'] },
          { id: 'step-pl-5-5', title: 'Retain certification decisions with reviewer and timestamp', order: 5, complianceTags: ['SOC2', 'SOX'], linkedStoryIds: ['US-7.19'] },
          { id: 'step-pl-5-6', title: 'Support JIT privileged access with auto-expiry', order: 6, complianceTags: ['NIST'], linkedStoryIds: ['US-7.34', 'US-7.35', 'US-7.36'] },
        ],
      },
      {
        ...
        order: 6,
        steps: [
          { id: 'step-pl-6-1', title: 'Provide comprehensive immutable audit logging', order: 1, complianceTags: ['SOC2', 'SOX', 'ISO27001'], linkedStoryIds: ['US-7.13', 'US-7.40', 'US-7.59'] },
          { id: 'step-pl-6-2', title: 'Capture approver identity, timestamps, and state changes', order: 2, complianceTags: ['SOC2', 'SOX'], linkedStoryIds: ['US-7.14'] },
          { id: 'step-pl-6-3', title: 'Configure log retention policies per compliance requirement', order: 3, complianceTags: ['SOC2', 'HIPAA'], linkedStoryIds: ['US-7.15'] },
          { id: 'step-pl-6-4', title: 'Scale ingestion and provisioning to enterprise volumes', order: 4, linkedStoryIds: ['US-7.55', 'US-7.56', 'US-7.57'] },
          { id: 'step-pl-6-5', title: 'Define and enforce 24x7 SLA for critical failures', order: 5, linkedStoryIds: ['US-7.52', 'US-7.53', 'US-7.54'] },
          { id: 'step-pl-6-6', title: 'Govern IGA admin access and prevent unauthorized provisioning', order: 6, complianceTags: ['SOC2', 'NIST'], linkedStoryIds: ['US-7.58', 'US-7.60'] },
          { id: 'step-pl-6-7', title: 'Preserve audit evidence integrity across platform upgrades', order: 7, complianceTags: ['SOC2', 'SOX'], linkedStoryIds: ['US-7.61', 'US-7.62', 'US-7.63'] },
        ],
      },
    ],
  },
